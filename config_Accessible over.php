...
<div class="card">
		<div class="card-header">
			<h1 align="center">Accessible over</h1>
		</div>
    <div class="card-body">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <tr>
                    <th>Access Type</th>
                    <td>
                        <input type="text" name="txtacctype" id="input" class="form-control" value="" required="required"  maxlength="50">
                    </td>                       
                </tr>
                <tr>
                    <th>Remarks</th>
    ...
    <?php
        if(isset($_POST['btnSubmit'])){
            $parfield1 = $_POST['txtacctype'];
            $parfield2 = $_POST['txtremark'];
            $tablename = "tbl_accessible_over";
            $id = "acc_id";
            $col1 = "acc_access_type";
            $col2 = "acc_rmark";
