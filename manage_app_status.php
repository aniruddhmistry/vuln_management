                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputAddress">Application Status Type</label>
                                <input type="text" class="form-control" id="inputAddress" placeholder="Application Status">
                            </div>
