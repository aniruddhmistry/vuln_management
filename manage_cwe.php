                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-6">
                                <label for="inputAddress">CWE ID</label>
                                <input type="text" class="form-control" id="inputAddress" placeholder="Vulnerability CWE ID">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="inputAddress">Vulnerability Name</label>
                                <input type="text" class="form-control" id="inputAddress" placeholder="Vulnerability Name">
                            </div>
